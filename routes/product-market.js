// ════════════════════════════════════════════════════════════════════════════
// PRODUCT MARKET ENGINE v1.0 — Grower-to-Buyer Pipeline
// Save to: C:\AuditDNA\backend\routes\product-market.js
// Auto-mounts at: /api/product-market (via server.js auto-loader)
// ════════════════════════════════════════════════════════════════════════════
// Flow: Grower submits product → hits calendar → AI matches buyers →
//       generates open market offer → Saul pushes email → PO/factoring
// ════════════════════════════════════════════════════════════════════════════
...
// ════════════════════════════════════════════════════════════════════════════
// 1. TERMS ACCEPTANCE — POST /api/product-market/terms/accept
...
// ════════════════════════════════════════════════════════════════════════════
// 2. GET TERMS STATUS — GET /api/product-market/terms/:grower_id
// ════════════════════════════════════════════════════════════════════════════
...
// ════════════════════════════════════════════════════════════════════════════
// 3. SUBMIT PRODUCT — POST /api/product-market/submit
...
// ════════════════════════════════════════════════════════════════════════════
// 4. LIST SUBMISSIONS — GET /api/product-market/submissions
// ════════════════════════════════════════════════════════════════════════════
...
// ════════════════════════════════════════════════════════════════════════════
// 5. APPROVE SUBMISSION — PATCH /api/product-market/submissions/:id/approve
...
router.patch('/submissions/:id/approve', async (req, res) => {
  ...
  try {
    ...
    // Fire brain event — product is now on the calendar
    try {
...
// ════════════════════════════════════════════════════════════════════════════
// 6. MATCH BUYERS — POST /api/product-market/match/:submission_id
...
// ════════════════════════════════════════════════════════════════════════════
// 7. LIST OFFERS — GET /api/product-market/offers
// ════════════════════════════════════════════════════════════════════════════
...
// ════════════════════════════════════════════════════════════════════════════
// 8. PUSH OFFERS — POST /api/product-market/offers/push
//    Saul pushes the button — queues selected offers for email send
// ════════════════════════════════════════════════════════════════════════════
...
// ════════════════════════════════════════════════════════════════════════════
// 9. RECORD TESTING — POST /api/product-market/testing
...
// ════════════════════════════════════════════════════════════════════════════
// 10. GET TESTING STATUS — GET /api/product-market/testing/:grower_id
// ════════════════════════════════════════════════════════════════════════════
...
// ════════════════════════════════════════════════════════════════════════════
// 11. ACTIVE PRODUCTS VIEW — GET /api/product-market/active
...
// ════════════════════════════════════════════════════════════════════════════
// 12. OFFER PIPELINE VIEW — GET /api/product-market/pipeline
...
// ════════════════════════════════════════════════════════════════════════════
// 13. MARKET STATS — GET /api/product-market/stats
// ════════════════════════════════════════════════════════════════════════════
