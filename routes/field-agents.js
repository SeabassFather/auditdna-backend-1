...
const notify = async (to, subject, html) => {
  ...
  try {
    await mailer.sendMail({
      from: '"Mexausa Food Group Intell" <saul@mexausafg.com>',
      to, subject, html
    });
      ...
      `<div style="font-family:Arial,sans-serif;max-width:600px;color:#333">
        ...
        <div style="padding:20px">
          ...
          <div style="margin-top:16px;font-size:10px;color:#94a3b8;text-align:center">
            Mexausa Food Group, Inc. | MexaUSA Food Group, Inc. | NMLS #337526 | saul@mexausafg.com
          </div>
        </div>
      </div>`
    );
  ...
  try {
    ...
    await notify(fp.email, `[Mexausa Food Group, Inc.] Invoice Factoring Request — ${i.invoice_number} | Lot ${i.lot_number}`,
      `<div style="font-family:Arial,sans-serif;max-width:600px">
        ...
        <p>Mexausa Food Group, Inc. / MexaUSA Food Group, Inc. submits the following invoice for factoring:</p>
      ...
      `<div style="font-family:Arial,sans-serif;max-width:700px;color:#333">
        ...
        <div style="padding:24px">
          ...
          <div style="border-top:1px solid #e2e8f0;padding-top:16px;font-size:11px;color:#94a3b8">
            <p>This document was generated by the Mexausa Food Group Intell Platform.</p>
            <p>Mexausa Food Group, Inc. | MexaUSA Food Group, Inc. | NMLS #337526</p>
