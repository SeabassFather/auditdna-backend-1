...
function buildHtml(prices, name, company) {
  ...
  return `<!DOCTYPE html><html><body style="margin:0;background:#0f172a;font-family:Arial,sans-serif"><table width="100%" cellpadding="0" cellspacing="0"><tr><td align="center" style="padding:24px 12px"><table width="600" cellpadding="0" cellspacing="0" style="background:#1e293b;border:1px solid rgba(203,166,88,0.25)"><tr><td style="background:#0a1220;padding:22px 28px;border-bottom:1px solid rgba(203,166,88,0.2)"><div style="font-size:10px;color:#64748b;letter-spacing:.1em;text-transform:uppercase">CM PRODUCTS INTERNATIONAL</div><div style="font-size:20px;color:#cba658;font-weight:700;margin-top:4px">Daily Market Price Sheet</div><div style="font-size:11px;color:#64748b;margin-top:2px">${date} | PACA #20241168</div></td></tr><tr><td style="padding:20px 28px 0"><p style="margin:0 0 8px;font-size:13px;color:#94a3b0">Dear ${name||'Valued Buyer'}${company?' — '+company:''},</p><p style="margin:0;font-size:13px;color:#94a3b0;line-height:1.6">Mexausa Food Group, Inc. offers today pricing <strong style="color:#cba658">15-20% below USDA wholesale</strong> on fresh produce sourced direct from growers in Mexico. FOB pricing. PACA guaranteed.</p></td></tr><tr><td style="padding:16px 28px"><table width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse"><thead><tr style="background:#0a1220"><th style="padding:8px 12px;text-align:left;font-size:10px;color:#64748b;text-transform:uppercase;border-bottom:1px solid rgba(203,166,88,0.2)">Commodity</th><th style="padding:8px 12px;text-align:left;font-size:10px;color:#64748b;text-transform:uppercase;border-bottom:1px solid rgba(203,166,88,0.2)">Pack</th><th style="padding:8px 12px;text-align:left;font-size:10px;color:#64748b;text-transform:uppercase;border-bottom:1px solid rgba(203,166,88,0.2)">USDA Market</th><th style="padding:8px 12px;text-align:left;font-size:10px;color:#cba658;text-transform:uppercase;border-bottom:1px solid rgba(203,166,88,0.2)">Mexausa Food Group</th><th style="padding:8px 12px;text-align:left;font-size:10px;color:#38bdf8;text-transform:uppercase;border-bottom:1px solid rgba(203,166,88,0.2)">You Save</th></tr></thead><tbody>${rows}</tbody></table></td></tr><tr><td style="padding:0 28px 20px"><div style="background:rgba(203,166,88,0.08);border:1px solid rgba(203,166,88,0.25);padding:14px 16px"><div style="font-size:11px;color:#64748b;text-transform:uppercase;margin-bottom:4px">Avg buyer savings per unit today</div><div style="font-size:24px;color:#cba658;font-weight:700">$${avg}</div></div></td></tr><tr><td style="padding:0 28px 24px;text-align:center"><a href="mailto:saul@mexausafg.com?subject=Price Inquiry" style="display:inline-block;padding:12px 28px;background:rgba(203,166,88,0.15);border:1px solid #cba658;color:#cba658;font-size:12px;font-weight:600;text-decoration:none">CONTACT US TO ORDER</a><p style="margin:10px 0 0;font-size:11px;color:#64748b">Saul Garcia | saul@mexausafg.com | +1-831-251-3116</p></td></tr><tr><td style="padding:12px 28px;background:#0a1220;border-top:1px solid rgba(203,166,88,0.1)"><p style="margin:0;font-size:10px;color:#334155">You received this as a registered produce buyer in the Mexausa Food Group network. <a href="https://mexausafg.com/unsubscribe" style="color:#64748b">Unsubscribe</a> | CAN-SPAM compliant</p></td></tr></table></td></tr></table><p style="font-size:10px;color:#64748b;border-top:1px solid #2d3748;margin-top:20px;padding-top:10px;font-family:Arial,sans-serif;">All shipments subject to USDA AMS inspection at point of origin, port of entry, and delivery as agreed by all parties. Rejection rights apply upon failed inspection. | Mexausa Food Group, Inc. | EIN: 88-1698129 | Salinas, CA | mexausafg.com | FSMA 204 Compliant</p></body></html>`;
}
...
async function runCampaign(pool, segment) {
  ...
  try {
    ...
    const subjects = { avocado:'Hass Avocado Pricing — Mexausa Food Group 17% Below USDA Wholesale', berry:'Strawberry / Blueberry / Raspberry — Mexausa Food Group Daily Price Sheet', vegetable:'Tomato / Pepper / Cucumber — Today\'s Mexausa Food Group Pricing', all:'Mexausa Food Group Daily Market Price Sheet' };
    ...
    for (const b of buyers) {
      try {
        await transporter.sendMail({ from:'"Mexausa Food Group, Inc." <saul@mexausafg.com>', to:b.email, subject:subjects[segment]||subjects.all, html:buildHtml(prices,b.name,b.company) });
        sent++;
