// =============================================================================
// FINANCIAL ROUTER — Self-contained (factoring, payment terms, credit risk,
...
const STANDARD_TERMS = [
  ...
  { code: '2NET10',  days: 30,  discount: 0.02, description: '2/10 Net 30 — 2% if paid in 10 days' },
  { code: '1NET15',  days: 45,  discount: 0.01, description: '1/15 Net 45 — 1% if paid in 15 days' },
...
router.get('/currency/rates',     (req, res) => res.json({ success: true, base: 'USD', rates: RATES, note: 'Static reference rates — not live' }));
