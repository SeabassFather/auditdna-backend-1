...
// GROWER PIPELINE ROUTES v1.1 â€” DEDICATED POOL
...
// â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
// DEDICATED POOL â€” isolated from main server pool (fixes timeout under load)
// â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
...
// â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
// 6b. DASHBOARD STATS â€” GET /api/growers/stats/summary
  ...
  try {
    ...
    try {
      ...
      if (sse && sse.broadcast) {
        sse.broadcast('autonomy.prediction_generated', {
          grower_id, commodity, yield_id: result.yield_id, deal_id: result.deal_id,
...
router.get('/intel',    async (req,res) => { const pool = req.app.get('db')||global.db; try { const r = await pool.query("SELECT COUNT(*) FROM shipper_contacts WHERE role='grower'"); res.json({ ok:true, growers: parseInt(r.rows[0].count) }); } catch(e){ res.json({ok:true,growers:0}); } });
