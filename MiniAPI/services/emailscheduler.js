...
const CONFIG = {
  sendGrid: {
    ...
    fromName: 'CM Products Market Intelligence'
  },
  schedule: {
...
<head>
  ...
  <title>CM Products Market Intelligence</title>
</head>
<body style="margin:0; padding:0; font-family: Georgia, serif; background:#f8fafc;">
  <div style="max-width:650px; margin:0 auto; background:#ffffff;">
    ...
    <div style="border-top:2px solid #e2e8f0; padding:1.5rem; text-align:center; background:#f8fafc;">
      <div style="font-weight:600; margin-bottom:0.5rem;">CM Products International | NMLS #337526</div>
  ...
  return {
    subject: `🥑 CM Products Market Intelligence - Week of ${date}`,
    html,
