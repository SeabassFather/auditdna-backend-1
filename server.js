...
try { app.use('/api/brain', require('./routes/brain-stream')); console.log('[OK] brain-stream mounted at /api/brain'); } catch(e) { console.error('[FAIL] brain-stream mount:', e.message); }
  ...
  try { const cal = require('./routes/calendar.routes'); app.use('/api/calendar', cal); console.log('[OK] calendar mounted at /api/calendar'); } catch(e) { console.error('[FAIL] calendar mount:', e.message); }
