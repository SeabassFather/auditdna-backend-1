...
try {
  ...
  try { app.use('/api/factor', require('./routes/factor-matchmaker')); console.log('[OK] factor-matchmaker.js mounted at /api/factor (Sprint C P3)'); } catch(e) { console.error('[FAIL] factor-matchmaker mount:', e.message); }
