...
// â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
// ── Grower Public Registration + Activation Queue ────────────────────────────
try {
  app.use('/api/growers', require('./routes/grower-public-register'));
  console.log('  [ROUTE] /api/growers (register-public, activate, reject, pending)');
} catch(e) {
  console.error('  [FAIL]  /api/growers --', e.message);
}
