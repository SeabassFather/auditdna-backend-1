...
pool.on('error', err => {
  console.error('âŒ PostgreSQL error:', err);
});
...
console.log('ðŸ§  THE BRAIN: Initializing 81 Niner Miners...');

// Brain event listeners for real-time monitoring
brain.on('taskAssigned', ({ workflowId, miner, team }) => {
  console.log(`â›ï¸  [BRAIN] Task assigned to ${miner} (${team}) - Workflow: ${workflowId}`);
});

brain.on('taskCompleted', ({ workflowId, miner, duration }) => {
  console.log(`âœ… [BRAIN] Task completed by ${miner} in ${duration}ms - Workflow: ${workflowId}`);
});
...
console.log('âœ… Sessions initialized (PostgreSQL)');
...
â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
â›ï¸  YEEHAW! 81 NINER MINERS ARE LIVE! â›ï¸
ðŸ§  THE BRAIN IS OPERATIONAL ðŸ§ 
â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
`);
});
...
function shutdown(signal) {
  ...
  server.close(() => {
    pool.end(() => {
      console.log('âœ… PostgreSQL closed');
      process.exit(0);
    });
  });
